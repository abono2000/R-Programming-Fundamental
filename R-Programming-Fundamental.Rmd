...
<img style="border-radius: 50%;" src="images/olawale.jpeg" width="150px"/>
...
[`r icons::fontawesome("twitter")` @bimbolawale](https://twitter.com/bimbolawale)
[`r icons::icon_style(icons::fontawesome("github"), scale = 1)` @olawale0254](https://github.com/olawale0254)
...
.footer[R code from throughout the slides is in the github repo [here](https://github.com/gbganalyst/R-Programming-Fundamental)]
---
...
### Extracting individual elements or components of a list
